      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: AnimatedSize(
              ...
              child: (!widget.model.validState) ? FadeIn(
                ...
                child: Texts.helperText("Please enter a valid state", Colors.red),
              ):SizedBox(),
          ...
          Container(
            ...
            child: CountryPicker(
              selectedCountry: widget.model.country,
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: Texts.text("+"+widget.model.country.dialingCode, themeModel.textColor),
                ),
